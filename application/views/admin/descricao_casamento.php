<script type="text/javascript">
    function alteraStatusEntregaCasamento(id_certidao) {
        var status = $("#status").val();
        $.ajax({
            url: '<?php echo base_url('Admin/alteraStatusEntregaCasamento') ?>',
            type: 'post',
...
<section>
    ...
    <dl class="row">
        <dt class="col-md-4"><h5>Nome do Noivo: <?php echo $certidao->nome_noivo ?> </h5></dt>
        <dd class="col-md-4"><h5>Nome da Noiva: <?php echo $certidao->nome_noiva ?></dd>
    </dl>
    <dl class="row">
        <dt class="col-md-4"><h5>Data do Casamento: <?php echo $certidao->data_casamento ?> </h5></dt>
        <dd class="col-md-4"><h5>Cidade do Casamento: <?php echo $certidao->cidade_casamento ?></dd>
    </dl>
    <hr>
    <dl class="row">
    ...
    <dl class="row">
        <?php if ($certidao->status == '3'): ?>
            <form id="alterarEntrega" class="form-inline">
                ...
                <button type="button" onclick="alteraStatusEntregaCasamento(<?php echo $certidao->id ?>);" class="btn btn-primary">Alterar</button>
            </form>
        <?php endif; ?>
