<script type="text/javascript">
    function alteraStatusEntregaNascimento(id_certidao) {
        var status = $("#status").val();
        $.ajax({
            url: 'Admin/alteraStatusEntregaNascimento',
            type: 'post',
...
<section>
    ...
    <dl class="row">
        <dt class="col-md-4"><h5>Nome: <?php echo $certidao->nome_noivo ?> </h5></dt>
        <dt class="col-md-4"><h5>Nome da Mãe: <?php echo $certidao->nome_noivo ?> </h5></dt>
        <dd class="col-md-4"><h5>Nome do Pai: <?php echo $certidao->nome_noiva ?></dd>
    </dl>
    <dl class="row">
        <dt class="col-md-4"><h5>Data de Nascimento: <?php echo $certidao->data_casamento ?> </h5></dt>
        <dd class="col-md-4"><h5>Cidade do Nascimento: <?php echo $certidao->cidade_casamento ?></dd>
    </dl>
    <hr>
    <dl class="row">
    ...
    <dl class="row">
        <?php if ($certidao->status == '3'): ?>
            <form id="alterarEntrega" class="form-inline">
                ...
                <button type="button" onclick="alteraStatusEntregaNascimento(<?php echo $certidao->id ?>);" class="btn btn-primary">Alterar</button>
            </form>
        <?php endif; ?>
    </dl>
